...
const translations = {
    en: {
        ...
        home: { subtitle: 'Submit a prayer and intercede for others — anonymously, from anywhere.', prayerLabel: 'Your Prayer', prayerPlaceholder: 'Lord, I pray for...', locationLabel: 'Your Location (Optional)', locationPlaceholder: 'e.g. Chicago, IL or Tokyo', locationPrivacy: 'Your exact location is never stored. We use privacy-preserving Geohashing.', submit: 'Submit Anonymously', anonNote: 'Your prayer is completely anonymous. An identity stub is securely attached to your session to manage your prayers.' },
        prayer: { prayerRequest: 'Anonymous Prayer', answeredPrayer: '🙌 Answered Prayer', prayed: '{n} Prayed', intercessors: '🌍 {n} Intercessor(s) from around the world', locationPlaceholder: 'Your location (optional) e.g. Lagos, Nigeria', locationPrivacyNote: '📍 Location is optional and privacy-preserving. Your exact coordinates are never stored.', iPrayed: '🙏 I Prayed', youPrayed: '✓ You Prayed For This', shareUrl: 'Share this URL', shareCopied: '✓ Copied to clipboard!', shareFailed: 'Could not share.', translateContent: '🌐 Translate this prayer', yourRequest: 'Your Prayer', editText: '✏️ Edit Prayer', saveChanges: 'Save Changes', cancel: 'Cancel', saving: 'Saving…', prayerUpdated: '✓ Prayer updated!', markAnswered: '✅ Mark as Answered', prayerAnswered: '🙌 This prayer was answered!' },
    ...
    pt: {
        ...
        home: { subtitle: 'Envie uma oração e interceda pelos outros — anonimamente, de qualquer lugar.', prayerLabel: 'Sua Oração', prayerPlaceholder: 'Senhor, eu oro por...', locationLabel: 'Sua Localização (Opcional)', locationPlaceholder: 'ex: São Paulo, SP ou Tóquio', locationPrivacy: 'Sua localização exata nunca é armazenada. Usamos Geohashing para preservar sua privacidade.', submit: 'Enviar Anonimamente', anonNote: 'Sua oração é completamente anônima. Uma identidade temporária é criada no dispositivo para gerenciar suas orações.' },
        prayer: { prayerRequest: 'Oração Anônima', answeredPrayer: '🙌 Oração Respondida', prayed: '{n} Oraram', intercessors: '🌍 {n} Intercessor(es) ao redor do mundo', locationPlaceholder: 'Sua localização (opcional) ex: Lagos, Nigéria', locationPrivacyNote: '📍 A localização é opcional e preserva sua privacidade. Suas coordenadas exatas nunca são armazenadas.', iPrayed: '🙏 Eu Orei', youPrayed: '✓ Você Orou Por Isso', shareUrl: 'Compartilhar esta URL', shareCopied: '✓ Copiado!', shareFailed: 'Não foi possível compartilhar.', translateContent: '🌐 Traduzir esta oração', yourRequest: 'Sua Oração', editText: '✏️ Editar Oração', saveChanges: 'Salvar Alterações', cancel: 'Cancelar', saving: 'Salvando…', prayerUpdated: '✓ Oração atualizada!', markAnswered: '✅ Marcar como Respondida', prayerAnswered: '🙌 Esta oração foi respondida!' },
    ...
    es: {
        ...
        home: { subtitle: 'Envía una oración e intercede por otros — anónimamente, desde cualquier lugar.', prayerLabel: 'Tu Oración', prayerPlaceholder: 'Señor, oro por...', locationLabel: 'Tu Ubicación (Opcional)', locationPlaceholder: 'ej: Ciudad de México o Tokio', locationPrivacy: 'Tu ubicación exacta nunca se almacena. Usamos Geohashing para proteger tu privacidad.', submit: 'Enviar Anónimamente', anonNote: 'Tu oración es completamente anónima. Se crea una identidad temporal en tu dispositivo.' },
        prayer: { prayerRequest: 'Oración Anónima', answeredPrayer: '🙌 Oración Respondida', prayed: '{n} Oraron', intercessors: '🌍 {n} Intercesor(es) alrededor del mundo', locationPlaceholder: 'Tu ubicación (opcional) ej: Lagos, Nigeria', locationPrivacyNote: '📍 La ubicación es opcional y protege tu privacidad. Tus coordenadas exactas nunca se almacenan.', iPrayed: '🙏 Oré', youPrayed: '✓ Oraste Por Esto', shareUrl: 'Compartir esta URL', shareCopied: '✓ ¡Copiado al portapapeles!', shareFailed: 'No se pudo compartir.', translateContent: '🌐 Traducir esta oración', yourRequest: 'Tu Oración', editText: '✏️ Editar Oración', saveChanges: 'Guardar Cambios', cancel: 'Cancelar', saving: 'Guardando…', prayerUpdated: '✓ ¡Oración actualizada!', markAnswered: '✅ Marcar como Respondida', prayerAnswered: '🙌 ¡Esta oración fue respondida!' },
    ...
    fr: {
        ...
        home: { subtitle: 'Soumettez une prière et intercédez pour les autres — anonymement, de partout.', prayerLabel: 'Votre Prière', prayerPlaceholder: 'Seigneur, je prie pour...', locationLabel: 'Votre Localisation (Optionnel)', locationPlaceholder: 'ex: Paris, France ou Tokyo', locationPrivacy: 'Votre localisation exacte n\'est jamais stockée. Nous utilisons le Geohashing pour protéger votre vie privée.', submit: 'Soumettre Anonymement', anonNote: 'Votre prière est totalement anonyme. Une identité temporaire est créée sur votre appareil.' },
        prayer: { prayerRequest: 'Prière Anonyme', answeredPrayer: '🙌 Prière Exaucée', prayed: '{n} ont prié', intercessors: '🌍 {n} Intercesseur(s) du monde entier', locationPlaceholder: 'Votre localisation (optionnel) ex: Lagos, Nigéria', locationPrivacyNote: '📍 La localisation est optionnelle et protège votre vie privée. Vos coordonnées exactes ne sont jamais stockées.', iPrayed: '🙏 J\'ai Prié', youPrayed: '✓ Vous Avez Prié Pour Cela', shareUrl: 'Partager cette URL', shareCopied: '✓ Copié dans le presse-papiers !', shareFailed: 'Impossible de partager.', translateContent: '🌐 Traduire cette prière', yourRequest: 'Votre Prière', editText: '✏️ Modifier la Prière', saveChanges: 'Enregistrer', cancel: 'Annuler', saving: 'Enregistrement…', prayerUpdated: '✓ Prière mise à jour !', markAnswered: '✅ Marquer comme Exaucée', prayerAnswered: '🙌 Cette prière a été exaucée !' },
    ...
    ko: {
        ...
        home: { subtitle: '기도를 올리고 다른 이들을 위해 중보하세요 — 어디서나, 익명으로.', prayerLabel: '나의 기도', prayerPlaceholder: '주님, 저는 기도합니다...', locationLabel: '위치 (선택사항)', locationPlaceholder: '예: 서울, 한국 또는 도쿄', locationPrivacy: '정확한 위치는 절대 저장되지 않습니다. 개인정보를 보호하는 Geohashing을 사용합니다.', submit: '익명으로 제출', anonNote: '기도는 완전히 익명입니다. 임시 식별자가 기기에 생성되어 기도를 관리합니다.' },
        prayer: { prayerRequest: '익명 기도', answeredPrayer: '🙌 응답된 기도', prayed: '{n}명이 기도함', intercessors: '🌍 전 세계 {n}명의 중보기도자', locationPlaceholder: '위치 (선택사항) 예: 서울, 한국', locationPrivacyNote: '📍 위치는 선택사항이며 개인정보를 보호합니다. 정확한 좌표는 절대 저장되지 않습니다.', iPrayed: '🙏 기도했습니다', youPrayed: '✓ 이 기도를 위해 기도하셨습니다', shareUrl: '이 URL 공유', shareCopied: '✓ 클립보드에 복사됨!', shareFailed: '공유할 수 없습니다.', translateContent: '🌐 이 기도 번역', yourRequest: '나의 기도', editText: '✏️ 기도 편집', saveChanges: '변경 사항 저장', cancel: '취소', saving: '저장 중…', prayerUpdated: '✓ 기도가 업데이트되었습니다!', markAnswered: '✅ 응답됨으로 표시', prayerAnswered: '🙌 이 기도가 응답되었습니다!' },
    ...
    id: {
        ...
        home: { subtitle: 'Kirim doa dan syafaatkan orang lain — secara anonim, dari mana saja.', prayerLabel: 'Doa Anda', prayerPlaceholder: 'Tuhan, aku berdoa untuk...', locationLabel: 'Lokasi Anda (Opsional)', locationPlaceholder: 'mis. Jakarta, Indonesia atau Tokyo', locationPrivacy: 'Lokasi tepat Anda tidak pernah disimpan. Kami menggunakan Geohashing yang melindungi privasi.', submit: 'Kirim Secara Anonim', anonNote: 'Doa Anda sepenuhnya anonim. Identitas sementara dibuat di perangkat Anda.' },
        prayer: { prayerRequest: 'Doa Anonim', answeredPrayer: '🙌 Doa Terjawab', prayed: '{n} mendoakan', intercessors: '🌍 {n} Pendoa Syafaat dari seluruh dunia', locationPlaceholder: 'Lokasi Anda (opsional) mis. Jakarta, Indonesia', locationPrivacyNote: '📍 Lokasi bersifat opsional dan melindungi privasi. Koordinat tepat Anda tidak pernah disimpan.', iPrayed: '🙏 Saya Sudah Berdoa', youPrayed: '✓ Anda Sudah Mendoakan Ini', shareUrl: 'Bagikan URL ini', shareCopied: '✓ Disalin ke clipboard!', shareFailed: 'Tidak dapat membagikan.', translateContent: '🌐 Terjemahkan doa ini', yourRequest: 'Doa Anda', editText: '✏️ Edit Doa', saveChanges: 'Simpan Perubahan', cancel: 'Batal', saving: 'Menyimpan…', prayerUpdated: '✓ Doa diperbarui!', markAnswered: '✅ Tandai sebagai Terjawab', prayerAnswered: '🙌 Doa ini telah terjawab!' },
