...
const translations = {
    ...
    pt: {
        ...
        home: { subtitle: 'Envie pedidos de oração e ore pelos outros — anonimamente, de qualquer lugar.', prayerLabel: 'Seu Pedido de Oração', prayerPlaceholder: 'Senhor, eu oro por...', locationLabel: 'Sua Localização (Opcional)', locationPlaceholder: 'ex: São Paulo, SP ou Tóquio', locationPrivacy: 'Sua localização exata nunca é armazenada. Usamos Geohashing para preservar sua privacidade.', submit: 'Enviar Anonimamente', anonNote: 'Seu pedido é completamente anônimo. Uma identidade temporária é criada no dispositivo para gerenciar seus pedidos.' },
    ...
    es: {
        ...
        home: { subtitle: 'Envía peticiones de oración y ora por otros — anónimamente, desde cualquier lugar.', prayerLabel: 'Tu Petición de Oración', prayerPlaceholder: 'Señor, oro por...', locationLabel: 'Tu Ubicación (Opcional)', locationPlaceholder: 'ej: Ciudad de México o Tokio', locationPrivacy: 'Tu ubicación exacta nunca se almacena. Usamos Geohashing para proteger tu privacidad.', submit: 'Enviar Anónimamente', anonNote: 'Tu petición es completamente anónima. Se crea una identidad temporal en tu dispositivo.' },
    ...
    ko: {
        ...
        home: { subtitle: '기도 요청을 올리고 다른 이들을 위해 기도하세요 — 어디서나, 익명으로.', prayerLabel: '기도 요청', prayerPlaceholder: '주님, 저는 기도합니다...', locationLabel: '위치 (선택사항)', locationPlaceholder: '예: 서울, 한국 또는 도쿄', locationPrivacy: '정확한 위치는 절대 저장되지 않습니다. 개인정보를 보호하는 Geohashing을 사용합니다.', submit: '익명으로 제출', anonNote: '요청은 완전히 익명입니다. 임시 식별자가 기기에 생성되어 요청을 관리합니다.' },
